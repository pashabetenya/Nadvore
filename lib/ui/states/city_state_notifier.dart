...
final cityStateNotifierProvider = StateNotifierProvider<CityStateNotifier, CityState>(
  (references) => CityStateNotifier(
    references.watch(getCityProvider),
    references.watch(setCityProvider),
  ),
);
